 ...
 * 社交按钮相关的配置同意放这
 */
module。exports = {CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/GoaLoad', // 你的twitter个人主页
                  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/ipotatooooo/', // 您的instagram地址
  ...
  CONTACT_EMAIL:
    ...
    'ipotato@momentum.edu.kg', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/GoaLoad', // 你的twitter个人主页
